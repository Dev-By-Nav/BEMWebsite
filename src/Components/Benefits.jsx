  ...
  return (
    <div className='flex flex-col md:flex-row py-20'>
        ...
        <div className="md:w-1/4 flex justify-center items-center flex-col py-6">
            ...
            <h1 className=" pt-5 font-montserrat text-xl text-white font-semibold">Tailored Solutions</h1>
        ...
        <div className="md:w-1/4 flex justify-center items-center flex-col py-6">
            ...
            <h1 className=" pt-5 font-montserrat text-xl text-white font-semibold">Reach New Customers</h1>
        ...
        <div className="md:w-1/4 flex justify-center items-center flex-col py-6">
            ...
            <h1 className=" pt-5 font-montserrat text-xl text-white font-semibold">Professional Branding</h1>
        ...
        <div className="md:w-1/4 flex justify-center items-center flex-col py-6">
            ...
            <h1 className=" pt-5 font-montserrat text-xl text-white font-semibold">Incredible Results</h1>
